...
def klCallback1(msg):
    ...
    if tf == 0:
        ...
        if size != 1 and size != 0:
            ...
            print('mu_min', mu_min)
            # print('mu_min_iti[0]', mu_min_iti[0])
            # print('mu_min_iti[1]', mu_min_iti[1])
            # print('mu_min_iti[2]', mu_min_iti[2])
            print('datax[mu_min_iti[0]]', datax[mu_min_iti[0]])
            print('datay[mu_min_iti[1]]', datay[mu_min_iti[1]])
            print('dataz[mu_min_iti[2]]', dataz[mu_min_iti[2]])
            ...
            print('U_max', U_max)
            print('datax[U_max_iti[0]]', datax[U_max_iti[0]])
            print('datay[U_max_iti[1]]', datay[U_max_iti[1]])
            print('dataz[U_max_iti[2]]', dataz[U_max_iti[2]])
